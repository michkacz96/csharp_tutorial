...
namespace Warriors
{
    class MagicWarrior : Warrior
    {
        ...
        public MagicWarrior(string name = "Magic Warrior", double health = 0, double attkMax = 0, double blockMax  = 0, int teleportChance = 0) : base(name, health, attkMax, blockMax)
        {
